...
Every lifecycle stage uses the same documentation structure so teams can learn one navigation pattern and apply it across the process:

1. Purpose: why the stage exists.
2. Stage Focus: what the team must concentrate on.
3. Inputs: artifacts, evidence, and decisions required to start.
4. Process: activities performed in sequence.
5. Core Concepts: stage-specific terminology and guidance.
6. Expected Outcome: what must be true when the stage is complete.
7. Artifacts: canonical files produced or updated.
8. Do: recommended practices.
9. Do Not: prohibited practices and common failure modes.
10. Templates: reusable structures for stage artifacts.
11. Review Checklist: readiness checks before transition.
12. Lifecycle and Change Control: how stage outputs evolve, freeze, version, and change.

Only the Core Concepts and Artifacts sections should vary substantially between stages. This shared structure reduces cognitive load and makes future stages predictable to read, review, and operate.

## 1. Define intent

Detailed guidance: [Define intent](/docs/software-specification/1-intent/README.md).
...
Detailed guidance: [Design](/docs/software-specification/2-design/README.md).
...
Detailed guidance: [Develop handoff](/docs/software-specification/3-develop-handoff/README.md).
...
Detailed guidance: [Test](/docs/software-specification/4-test/README.md).
...
Detailed guidance: [Deploy and operate](/docs/software-specification/5-deploy-operate/README.md).
